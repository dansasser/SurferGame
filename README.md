...
This example can be installed as a PWA and played offline courtesy Gorombo Software and Web Development.

View on Github: [**Click Here**](https://github.com/dansasser/SurferGame)
